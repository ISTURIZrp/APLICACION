...
function showNotification(title, message, type = 'info') {
    ...
    setTimeout(() => { 
        notificationDiv.className = 'show ' + type; // Esto asegura que la clase se mantenga por el tiempo del timeout
...
document.addEventListener('click', (e) => {
    if (!userInfoBox.contains(e.target) && !userDropdown.contains(e.target)) {
